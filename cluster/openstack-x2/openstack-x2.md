...
```
                          ...
                          10.6.11.0/24                            10.6.12.0/24
                              |                                       |
  +-----------------------------------+  +-----------------------------------+
  | contrail-a   10.6.8.1  10.6.11.1  |  | contrail-b   10.6.8.11  10.6.12.1 |
  | openstack-a  10.6.8.2  10.6.11.2  |  | openstack-b  10.6.8.12  10.6.12.2 |
  | compute-a    10.6.8.3  10.6.11.3  |  | compute-b    10.6.8.13  10.6.12.3 |
  | command-a    10.6.8.9  10.6.11.9  |  | command-b    10.6.8.19  10.6.12.9 |
  +-----------------------------------+  +-----------------------------------+
                    |                                      |
                    +--------------------------------------+
                                       |
